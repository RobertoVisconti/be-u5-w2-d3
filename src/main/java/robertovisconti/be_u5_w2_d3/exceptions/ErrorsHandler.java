...
import robertovisconti.be_u5_w2_d3.payloads.ErrorsPayload;
...
public class ErrorsHandler {
    ...
    public ErrorsPayload handleGenericException(Exception ex) {
        ex.printStackTrace();
        return new ErrorsPayload("Errore interno al server, risolveremo il prima possibile.", LocalDateTime.now());
    }
